...
class RosesTest < ApplicationSystemTestCase
  ...
  test "creating a Rose" do
    ...
    fill_in "Creationdate", with: @rose.creationDate
    fill_in "Description", with: @rose.description
    fill_in "Family", with: @rose.family
    fill_in "Latitude", with: @rose.latitude
    fill_in "Longitude", with: @rose.longitude
